...
const serviceSubTypeValidation = require('../../validations/serviceSubType.validation');
const serviceSubTypeController = require('../../controllers/serviceSubType.controller');
...
router
  ...
  .delete(
    auth('manageUsers'),
    validate(serviceSubTypeValidation.deleteSubService),
    serviceSubTypeController.deleteSubService
  );
