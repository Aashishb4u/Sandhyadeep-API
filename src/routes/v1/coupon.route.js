...
router
  ...
  .get(auth('getUsers'), validate(couponValidation.getCoupons), couponController.getCoupons);

router
  .route('/:couponId')
  .get(auth('getUsers'), validate(couponValidation.getCoupon), couponController.getCoupon)
